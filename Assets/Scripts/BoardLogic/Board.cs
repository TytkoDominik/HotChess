...
namespace BoardLogic
{
    public class Board
    {
        ...
        public Board()
        {
            ...
            ChessPieceData.Add(new ChessPieceData(new Vector2(4, 0), PieceType.Queen, PieceColor.White));
            ChessPieceData.Add(new ChessPieceData(new Vector2(4, 7), PieceType.Queen, PieceColor.Black));
            
            ChessPieceData.Add(new ChessPieceData(new Vector2(3, 0), PieceType.King, PieceColor.White));
            ChessPieceData.Add(new ChessPieceData(new Vector2(3, 7), PieceType.King, PieceColor.Black));
        }
