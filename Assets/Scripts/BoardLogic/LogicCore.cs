...
namespace BoardLogic
{
    public class LogicCore
    {
        ...
        private List<Move> GetLegalMoves(Vector2 position, Board board)
        {
        ...
        private List<Move> GetPossibleMoves(Vector2 position, Board board)
        {
        ...
        private List<Move> GetThreatMoves(Vector2 position, Board board)
        {
            var data = board.GetPieceData(position);
        ...
        private bool IsCheck(PieceColor color, Board board)
        {
            return GetThreatPositionsForColor(color, board).Any(p => p == board.KingPosition(color));
        }
        
        private List<Vector2> GetThreatPositionsForColor(PieceColor color, Board board)
        {
        ...
        private bool IsCheckMate(PieceColor color, Board board)
        {
            return IsCheck(color, board) && GetAntiCheckMoves(color, board).IsEmpty();
        }

        private List<Move> GetAntiCheckMoves(PieceColor color, Board board)
        {
